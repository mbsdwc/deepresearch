...
class SummarizationService:
    ...
    def summarize_task(self, state: SummaryState, task: TodoItem, context: str, verify_result: str) -> str:
        """Generate a task-specific summary using the summarizer agent."""

        prompt = self._build_prompt(state, task, context, verify_result)
    ...
    def stream_task_summary(
        self, state: SummaryState, task: TodoItem, context: str, verify_result: str
    ...
    def _build_prompt(self, state: SummaryState, task: TodoItem, context: str, verify_result: str) -> str:
